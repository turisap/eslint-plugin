...
import { getESLintCoreRule, deepMerge, createRule } from '../utils';
import { ESLintUtils } from'@typescript-eslint/utils'

const baseRule = getESLintCoreRule('no-magic-numbers')

type Options = ESLintUtils.InferOptionsTypeFromRule<typeof baseRule>;
type MessageIds = ESLintUtils.InferMessageIdsTypeFromRule<typeof baseRule>;
